...
2.Compile and download the host program SPI_TwoBoards_FullDuplexMaster_Polling
_Init
3.Compile and download the slave program SPI_TwoBoards_FullDuplexSlave_Polling
_Init
