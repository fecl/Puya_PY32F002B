...
This sample demonstrates the clock output function, which can output HSE 
waveforms.
================================================================================
测试环境：
测试用板：PY32F002B_STK
...
2. connecting the PA06 pin to the external 24MHz clock;
3. pressing the user button;
4. The PA07 output HSE waveform (24MHz) can be observed by the oscilloscope.
================================================================================
注意事项：
如果需要使用按键:
